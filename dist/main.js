!(function (e) {
  ...
  function (e, t, i) {
    ...
    var a = function (e) {
      return e.checkTimeMovement(n.hookDownMovement)
        ? n.hookDown
        : e.checkTimeMovement(n.hookUpMovement)
          ? n.hookUp
          : n.hookNormal;
    };
    t.getHookStatus = a;
    t.touchEventHandler = function (e) {
      if (
        e.getVariable(n.gameStartNow) &&
        !((e.debug && e.paused) || a(e) !== n.hookNormal)
      ) {
        (e.removeInstance("tutorial"), e.removeInstance("tutorial-arrow"));
        var t = e.getInstance("block_".concat(e.getVariable(n.blockCount)));
        t &&
          t.status === n.swing &&
          (e.setTimeMovement(n.hookUpMovement, 500), (t.status = n.beforeDrop));
      }
    };
    t.addSuccessCount = function (e) {
      var t = e.getVariable(n.gameUserOption).setGameSuccess,
        i = e.getVariable(n.successCount) + 1;
      (e.setVariable(n.successCount, i),
        e.getVariable(n.hardMode) &&
          e.setVariable(n.ropeHeight, e.height * e.utils.random(0.35, 0.55)),
        t && t(i));
    };
    t.addFailedCount = function (e) {
      ...
      (e.setVariable(n.failedCount, i),
        ...
        i >= 3 &&
          (e.pauseAudio("bgm"),
          e.playAudio("game-over"),
          e.setVariable(n.gameStartNow, !1)));
    };
    t.addScore = function (e, t) {
      var i = e.getVariable(n.gameUserOption),
        ...
        u = t ? s + 1 : 0,
        l = c + (r || 25) + (o || 25) * u;
      (e.setVariable(n.gameScore, l),
        e.setVariable(n.perfectCount, u),
        a && a(l));
    };
    t.drawYellowString = function (e, t) {
      ...
      (l.addColorStop(0, "#FAD961"),
        ...
        (s.lineWidth = u),
        (s.strokeStyle = "#FFF"),
        (s.textAlign = o || "center"),
        (s.font = "".concat(c, "px ").concat("wenxue")),
        s.strokeText(i, a, r),
        s.fillText(i, a, r),
        s.restore());
    };
  ...
  function (e, t, i) {
    ...
    var r = function (e, t) {
      ...
      if (i) {
          ...
          var s = (function (e, t) {
            ...
            return {
              bottomToTop: {
                ...
                y: n,
                vx: 0,
                vy: 0.7 * e.pixelsPerFrame(n) * -1,
              },
              leftToRight: {
                x: -1 * o,
                y: n * r(0.3, 0.6),
                vx: 0.4 * e.pixelsPerFrame(i),
                vy: 0.1 * e.pixelsPerFrame(n) * -1,
              },
              rightToLeft: {
                x: i,
                y: n * r(0.2, 0.5),
                vx: 0.4 * e.pixelsPerFrame(i) * -1,
                vy: 0.1 * e.pixelsPerFrame(n),
              },
              rightTopToLeft: {
                x: i,
                y: 0,
                vx: 0.6 * e.pixelsPerFrame(i) * -1,
                vy: 0.5 * e.pixelsPerFrame(n),
              },
            }[t];
          })(t, r);
          ((e.ready = !0),
        ...
        ((e.x += e.vx),
          (e.y += e.vy),
          (e.y + o < 0 || e.y > t.height || e.x + o < 0 || e.x > t.width) &&
            (e.visible = !1));
      }
    };
    t.flightAction = r;
    ...
    t.addFlight = function (e, t, i) {
      if (e.getVariable(a.flightCount) !== t) {
        ...
        ((s.imgName = "f".concat(t)),
          (s.type = i),
          e.addInstance(s, a.flightLayer),
          e.setVariable(a.flightCount, t));
      }
    };
  },
  function (e, t, i) {
    ...
    var r = function (e, t) {
      e.status === a.rotateLeft
        ? e.y - e.width >= t.height &&
          ((e.visible = !1), (e.status = a.out), (0, n.addFailedCount)(t))
        : e.y >= t.height &&
          ((e.visible = !1), (e.status = a.out), (0, n.addFailedCount)(t));
    };
    t.blockAction = function (e, t, i) {
      ...
      if (o.visible) {
        o.ready ||
          ((o.ready = !0),
          (o.status = a.swing),
          e.updateWidth(t.getVariable(a.blockWidth)),
          e.updateHeight(t.getVariable(a.blockHeight)),
          (e.x = t.width / 2),
          (e.y = -1.5 * s));
        ...
        switch (o.status) {
            ...
            (t.getTimeMovement(
              ...
              (function (e, t, i) {
                ...
                if (e.status === a.swing) {
                  ...
                  ((o.angle = s * (0, n.getSwingBlockVelocity)(t, i)),
                    (o.weightX = o.x + Math.sin(o.angle) * r),
                    (o.weightY = o.y + Math.cos(o.angle) * r));
                }
              })(e, t, i));
            break;
          case a.beforeDrop:
            ((o.x = e.weightX - e.calWidth),
              (o.y = e.weightY + 0.3 * e.height),
              (o.rotate = 0),
              (o.ay = t.pixelsPerFrame(3e-4 * t.height)),
              (o.startDropTime = i),
              (o.status = a.drop));
            break;
          case a.drop:
            ...
            ((o.startDropTime = i),
              (o.vy += o.ay * u),
              (o.y += o.vy * u + 0.5 * o.ay * Math.pow(u, 2)));
            var l = (function (e, t) {
                return e.y + e.height >= t.y
                  ? e.x < t.x - e.calWidth || e.x > t.collisionX + e.calWidth
                    ? 1
                    : e.x < t.x
                      ? 2
                      : e.x > t.collisionX
                        ? 3
                        : e.x > t.x + 0.8 * e.calWidth &&
                            e.x < t.x + 1.2 * e.calWidth
                          ? 5
                          : 4
                  : 0;
              })(e, c),
              d = c.y - e.height,
              h = function (e) {
                ((e.originOutwardAngle = Math.atan(e.height / e.outwardOffset)),
                  (e.originHypotenuse = Math.sqrt(
                    Math.pow(e.height, 2) + Math.pow(e.outwardOffset, 2),
                  )),
                  t.playAudio("rotate"));
              };
            switch (l) {
              case 1:
                ...
                break;
              case 2:
                ((o.status = a.rotateLeft),
                  (e.y = d),
                  (e.outwardOffset = c.x + e.calWidth - e.x),
                  h(e));
                break;
              case 3:
                ((o.status = a.rotateRight),
                  (e.y = d),
                  (e.outwardOffset = c.collisionX + e.calWidth - e.x),
                  h(e));
                break;
              case 4:
              case 5:
                ...
                ((0, n.addSuccessCount)(t),
                  t.setTimeMovement(a.moveDownMovement, 500),
                  (10 !== g && 15 !== g) ||
                    t.setTimeMovement(a.lightningMovement, 150),
                  (e.y = d),
                  (c.y = d),
                  (c.x = o.x - o.calWidth),
                  (c.collisionX = c.x + o.width));
                var f = 0.3 * o.width;
                ((o.x > t.width - 2 * f || o.x < -f) &&
                  t.setVariable(a.hardMode, !0),
                  5 === l
                    ? ((e.perfect = !0),
                      (0, n.addScore)(t, !0),
                      t.playAudio("drop-perfect"))
                    : ((0, n.addScore)(t), t.playAudio("drop")));
            }
            break;
          case a.land:
            (t.getTimeMovement(
          ...
          case a.rotateRight:
            ...
            if (p)
              ((e.rotate += (m / 8) * y),
                (e.y += t.pixelsPerFrame(0.7 * t.height)),
                (e.x += t.pixelsPerFrame(0.3 * t.width) * y));
            else {
              var b = (e.calWidth - e.outwardOffset) / e.calWidth;
              ((b = b > 0.5 ? b : 0.5), (e.rotate += m * b * y));
              var w = e.originOutwardAngle + e.rotate,
                k = v ? c.collisionX + e.calWidth : c.x + e.calWidth,
                O = c.y;
              ((e.x = k - Math.cos(w) * e.originHypotenuse),
                (e.y = O - Math.sin(w) * e.originHypotenuse));
            }
            r(e, t);
        }
      }
    ...
    t.endAnimate = function (e) {
      if (e.getVariable(s.gameStartNow)) {
        ...
        var o = e.getImg("score"),
          ...
          l = 0.35 * e.width,
          d = (u * l) / c;
        (e.ctx.drawImage(o, 0.61 * e.width, 0.038 * e.width, l, d),
          (0, r.drawYellowString)(e, {
            string: n,
            size: 0.06 * e.width,
            x: 0.88 * e.width,
        ...
        for (
          ...
          (h.save(),
            y <= i && (h.globalAlpha = 0.2),
            h.drawImage(g, 0.66 * e.width + (y - 1) * m, 0.16 * e.width, m, p),
            h.restore());
      }
    };
      ...
      if (e.getVariable(s.gameStartNow)) {
        ...
        if (!t || [s.land, s.out].indexOf(t.status) > -1) {
          ...
          var i = (0, r.getAngleBase)(e),
            c =
              (Math.PI *
                e.utils.random(i, i + 5) *
                e.utils.randomPositiveNegative()) /
              180;
          (e.setVariable(s.blockCount, e.getVariable(s.blockCount) + 1),
            e.setVariable(s.initialAngle, c),
            e.setTimeMovement(s.hookDownMovement, 500));
  ...
  function (e, t, i) {
    ...
    t.tutorialAction = function (e, t, i) {
      ...
      if (!e.ready) {
        ...
        (e.updateWidth(o),
          (e.height = 0.46 * o),
          (e.x = t.calWidth - e.calWidth),
          (e.y = 0.45 * a),
          "tutorial" !== r && (e.y += 1.2 * e.height));
      }
      "tutorial" !== r && (e.y += Math.cos(i / 200) * e.height * 0.01);
    };
    t.tutorialPainter = function (e, t) {
      if (
        !t.checkTimeMovement(a.tutorialMovement) &&
        (0, n.getHookStatus)(t) === a.hookNormal
      ) {
        var i = t.ctx,
          r = e.name,
          o = t.getImg(r);
  ...
  function (e, t, i) {
    ...
    t.hookAction = function (e, t, i) {
      var r = t.getVariable(a.ropeHeight);
      (e.ready || ((e.x = t.width / 2), (e.y = -1.5 * r), (e.ready = !0)),
        t.getTimeMovement(
          a.hookUpMovement,
          [[e.y, e.y - r]],
          function (t) {
      ...
      ((e.angle = o * (0, n.getSwingBlockVelocity)(t, i)),
        (e.weightX = e.x + Math.sin(e.angle) * r),
        (e.weightY = e.y + Math.cos(e.angle) * r));
    };
    t.hookPainter = function (e, t) {
      ...
      (i.save(),
        i.translate(e.x, e.y),
        i.rotate(2 * Math.PI - e.angle),
        i.translate(-e.x, -e.y),
        t.ctx.drawImage(o, e.x - r / 2, e.y, r, n + 5),
        i.restore());
    };
  },
  function (e, t, i) {
    ...
    t.cloudAction = function (e, t) {
      if (!e.ready) {
        ((e.ready = !0),
          r(e),
          (e.width = t.getVariable(a.cloudSize)),
          (e.height = t.getVariable(a.cloudSize)));
        var i = t.width,
          o = t.height,
          s = [
            { x: 0.1 * i, y: 0.66 * -o },
        ...
        ((e.x = t.utils.random(s.x, 1.2 * s.x)),
          (e.originX = e.x),
          (e.ax = t.pixelsPerFrame(
            e.width *
              t.utils.random(0.05, 0.08) *
              t.utils.randomPositiveNegative(),
          )),
          (e.y = t.utils.random(s.y, 1.2 * s.y)));
      }
      ((e.x += e.ax),
        (e.x >= e.originX + e.width || e.x <= e.originX - e.width) &&
          (e.ax *= -1),
        (0, n.checkMoveDown)(t) && (e.y += 1.2 * (0, n.getMoveDownValue)(t)),
        e.y >= t.height && ((e.y = 0.66 * -t.height), (e.count += 4), r(e)));
    };
  ...
  function (e, t, i) {
    ...
    t.lineAction = function (e, t, i) {
      var r = e;
      (r.ready ||
        ((r.y = t.getVariable(a.lineInitialOffset)),
        (r.ready = !0),
        (r.collisionX = t.width - t.getVariable(a.blockWidth))),
        t.getTimeMovement(
          a.moveDownMovement,
          [
            [
  ...
  function (e, t, i) {
    ...
    var r = function (e) {
      ...
      o > e.height ||
        ...
        e.getTimeMovement(a.bgInitMovement, [[o, o + r / 4]], function (e) {
          o = e;
        }),
        e.setVariable(a.bgImgOffset, o),
        e.setVariable(a.lineInitialOffset, e.height - 0.394 * r),
        e.ctx.drawImage(t, 0, o, e.width, r));
    };
    t.backgroundImg = r;
    var o = function (e, t, i) {
      ...
      s = function (e) {
        ...
        (0, n.checkMoveDown)(e) &&
          e.setVariable(
            a.bgLinearGradientOffset,
            r + 1.5 * (0, n.getMoveDownValue)(e),
          );
        ...
        (t.addColorStop(0, l),
          ...
          (e.ctx.fillStyle = t),
          e.ctx.beginPath(),
          e.ctx.rect(0, 0, e.width, e.height),
          e.ctx.fill());
        var d = function () {
  ...
  function (e, t, i) {
    ...
    (Object.defineProperty(t, "__esModule", { value: !0 }),
      (t.arraySwap =
        t.requestAnimationFrameTool =
        t.isTouchDevice =
        t.isFunction =
        t.randomPositiveNegative =
        t.random =
        t.getCurrentTime =
          void 0));
    var n = function () {
        ...
        function e() {
          ...
          if (
            ...
            ((this.canvas = document.getElementById(i)),
              s &&
                ((this.canvas.style.width = "".concat(d, "px")),
                (this.canvas.style.height = "".concat(h, "px")),
                (d *= 2),
                (h *= 2)),
              (this.highResolution = s),
              (this.canvas.width = d),
          ...
          (i = [
            ...
            },
            {
              ...
              value: function (e) {
                ...
                this.paused
                  ...
                  : (this.tick(i),
                    this.clean(),
                    this.startAnimate(this, i),
                    this.paintUnderInstance(this),
                    this.updateInstances(i),
                    this.paintInstances(),
                    this.paintAboveInstance(),
                    this.endAnimate(this, i),
            ...
            },
            {
              ...
              value: function () {
                (this.ctx.save(),
                  ...
                  (this.ctx.font = "".concat(
                    this.highResolution ? 32 : 16,
                    "px Arial",
                  )),
                  this.ctx.fillText(
                    "FPS: ".concat(this.fps.toFixed()),
                    5,
            ...
            },
            {
              ...
              value: function (e, t) {
                var i,
                  ...
                  a = [0, t],
                  r = [this.width, t];
                (e && ((a = [e, 0]), (r = [e, this.height])),
                  this.ctx.save(),
                  (this.ctx.strokeStyle = "red"),
                  this.ctx.beginPath(),
                  (i = this.ctx).moveTo.apply(i, o(a)),
                  (n = this.ctx).lineTo.apply(n, o(r)),
                  this.ctx.stroke(),
                  this.ctx.restore());
              },
            },
            {
              ...
              value: function (e, t) {
                (this.ctx.save(),
                  (this.ctx.fillStyle = "red"),
                  this.ctx.beginPath(),
                  this.ctx.arc(e, t, 2, 0, 2 * Math.PI, !0),
                  this.ctx.fill(),
                  (this.ctx.fillStyle = "white"),
                  this.ctx.beginPath(),
                  this.ctx.arc(e, t, 1, 0, 2 * Math.PI, !0),
                  this.ctx.fill(),
                  this.ctx.restore());
              },
            },
            ...
            },
            {
              ...
              value: function () {
                ...
                (this.timeMovementStartArr.forEach(function (t) {
                  ...
                  (this.timeMovementStartArr = []),
                  this.timeMovementFinishArr.forEach(function (t) {
            ...
            },
            {
              ...
              value: function (e, t, i) {
                ...
                if (l) {
                  l.processing ||
                    ("hook" === a.name && console.log(t),
                    this.timeMovementStartArr.push(e),
                    (l.store[u] = []),
                  ...
                  this.checkTimeMovement(e)
                    ? d()
                    : (this.timeMovementFinishArr.push(e), d(!0), s && s());
                }
              },
            },
            {
              ...
              value: function (e) {
                var t =
                  arguments.length > 1 && void 0 !== arguments[1]
                    ? arguments[1]
                    : this.defaultLayer;
                this.getInstance(e, t) &&
                  (this.instancesObj[t] = this.instancesObj[t].filter(
                    function (t) {
                      return t.name !== e;
                    },
                  ));
            ...
            },
            {
              ...
              value: function () {
                ...
                ((this.paused = !this.paused),
                  this.paused
                    ? (this.lastPausedAt = e)
                    : (this.pausedTime += e - this.lastPausedAt));
              },
            },
            {
            ...
            },
            {
              ...
              value: function (e, t) {
                return "keyup" === t
                  ? this.keyUpListeners[e]
                  : "keydown" === t
                    ? this.keyDownListeners[e]
                    : this.keyPressListeners[e];
              },
            },
            {
              key: "keyListener",
                ...
                var i = this,
                  n = setInterval(function () {
                    var a = i.assetsCount.image + i.assetsCount.audio,
                      r =
                        Object.keys(i.assetsObj.image).length +
                        Object.keys(i.assetsObj.audio).length;
                    (t &&
                      u(t) &&
                      t({ success: r, failed: i.assetsErrorCount, total: a }),
                      i.assetsErrorQueue.length > 0 &&
                        (i.assetsErrorQueue.forEach(function (e) {
                          var t = e.retry,
                            n = e.name,
                            a = e.src,
                            r = e.type;
                          t >= i.loadLimit
                            ? (i.assetsErrorCount += 1)
                            : "image" === r
                              ? i.addImg(n, a, t)
                              : i.addAudio(n, a, t);
                        }),
                        (i.assetsErrorQueue = [])),
                      r === a &&
                        (e && u(e) ? e() : i.init(), clearInterval(n)));
                  }, 200);
              },
            },
            {
  ...
  function (e, t, i) {
    ...
    window.TowerGame = function () {
      ...
      (f.addImg("background", v("background.png")),
        f.addImg("hook", v("hook.png")),
        f.addImg("blockRope", v("block-rope.png")),
        f.addImg("block", v("block.png")),
        f.addImg("block-perfect", v("block-perfect.png")));
      for (var m = 1; m <= 8; m += 1)
        f.addImg("c".concat(m), v("c".concat(m, ".png")));
      f.addLayer(l.flightLayer);
      for (var p = 1; p <= 7; p += 1)
        f.addImg("f".concat(p), v("f".concat(p, ".png")));
      (f.swapLayer(0, 1),
        ...
        f.setVariable(l.blockWidth, 0.25 * f.width),
        f.setVariable(l.blockHeight, 0.71 * f.getVariable(l.blockWidth)),
        f.setVariable(l.cloudSize, 0.3 * f.width),
        f.setVariable(l.ropeHeight, 0.7 * f.height),
        f.setVariable(l.blockCount, 0),
        f.setVariable(l.successCount, 0),
        f.setVariable(l.failedCount, 0),
      ...
      return (
        f.addInstance(k),
        (f.startAnimate = d.startAnimate),
        (f.endAnimate = d.endAnimate),
        (f.paintUnderInstance = r.background),
        f.addKeyDownListener("enter", function () {
        ...
        (f.start = function () {
          ...
          (f.addInstance(t),
            f.setTimeMovement(l.bgInitMovement, 500),
            f.setTimeMovement(l.tutorialMovement, 500),
            f.setVariable(l.gameStartNow, !0));
        }),
        f
      );
    };
